...
* `unzipper` issue where they discuss about memory leaks related stuff: https://github.com/ZJONSSON/node-unzipper/issues/191
* Micro vs. Macro tasks on the event loop: https://javascript.info/event-loop
